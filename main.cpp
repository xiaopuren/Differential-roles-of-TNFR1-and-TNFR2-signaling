...
int simu_step = 60000000 ;//1000000000;
double time_step = 5; //nano second
...
double mono_cis_Ass_Rate = 0.00116;
double mono_cis_Diss_Rate = 0.000000101;    // This 0.1 means the monomer cis will dissociate automatically

double cis_D = 0.5;      // two different cis interaction: (1) two single receptors (2)
double cis_rot_D = 0.005;
double cis_Ass_Rate = 0.0046;
double cis_Diss_Rate = 0.000000101;

double bond_D = 0.5;
double bond_rot_D = 0.005;
double Ass_Rate = 0.0085; //units: per nanosecond
double Diss_Rate = 0.0000000000105;
